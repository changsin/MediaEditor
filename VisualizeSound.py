...
#
#
# def visualize_sound(file_in, file_out, threshold=DEFAULT_THRESHOLD, window_size=DEFAULT_WINDOW_SIZE):
#     audio_clip = AudioSegment.from_file(file_in, format="mp3")
#
#     audio_clip_ar = np.frombuffer(audio_clip.raw_data, dtype='int16')
#
#     duration = len(audio_clip_ar) / audio_clip.frame_rate
#     # Find the sound wave timestamps
#     time_ar = np.linspace(start=0,
#                           stop=duration,
#                           num=len(audio_clip_ar))
#
#     print(f'duration', {duration},
#           f'frame_rate: ', {audio_clip.frame_rate}, audio_clip_ar[:20])
#
#     plt.plot(time_ar, audio_clip_ar)
#     plt.show()
#
#
# def visualize_sounds(path_in, path_out, threshold=DEFAULT_THRESHOLD, window_size=DEFAULT_WINDOW_SIZE):
...
#         visualize_sound(file_in, file_out, threshold=threshold, window_size=window_size)
#
...
#     visualize_sounds(args.path_in, args.path_out, threshold=threshold, window_size=window_size)
...
#
#
# ipd.Audio('data/regression/40A_M_0154_6.mp3')
# filename1 = 'data/regression/40A_M_0154_6.mp3'
